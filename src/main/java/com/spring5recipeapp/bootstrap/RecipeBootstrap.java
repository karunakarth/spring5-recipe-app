package com.spring5recipeapp.bootstrap;

import com.spring5recipeapp.domain.*;
import com.spring5recipeapp.repositories.CategoryRepository;
import com.spring5recipeapp.repositories.RecipeRepository;
import com.spring5recipeapp.repositories.UnitOfMeasureRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent event) {
        log.debug("loading all the recipes");
